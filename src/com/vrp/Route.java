...
public class Route {
	...
	private ArrayList<Customer> customers; //list of customers served in the route
...
//		print.append("\n" + "Route[" + index + "]");
		print.append("--------------------------------------------");
		print.append("\n" + "| Capacity=" + cost.load + " ServiceTime=" + cost.serviceTime + " TravelTime=" + cost.travelTime + "\n WaitingTime=" + cost.waitingTime +" Totaltime=" + cost.total);
		print.append("\n" + cost);
		print.append("\n");
		return print.toString();
	}
